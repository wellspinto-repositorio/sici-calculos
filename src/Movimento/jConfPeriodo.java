...
public class jConfPeriodo extends javax.swing.JInternalFrame {
    ...
    public jConfPeriodo() throws JRException {
        ...
        // Icone da tela
        FlatSVGIcon icone = new FlatSVGIcon("menuIcons/conferencia.svg",16,16);
        setFrameIcon(icone);        
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(402, 82));
        setMinimumSize(new java.awt.Dimension(402, 82));
        setPreferredSize(new java.awt.Dimension(402, 82));
        setVisible(true);
