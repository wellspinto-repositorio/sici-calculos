...
public class NamedPreparedStatement extends PreparedStatementImpl {
    ...
    public static NamedPreparedStatement prepareStatement(Connection conn, String sql, int type) throws SQLException {
        ...
        return new NamedPreparedStatement(conn.prepareStatement(parsedQuery.toString(), ResultSet.TYPE_SCROLL_INSENSITIVE, type), sql, orderedParameters);
    }

    public static NamedPreparedStatement prepareStatementII(Connection conn, String sql, int type) throws SQLException {
        List<String> orderedParameters = new ArrayList<String>();
        int length = sql.length();
        StringBuffer parsedQuery = new StringBuffer(length);
        boolean inSingleQuote = false;
        ...
        return new NamedPreparedStatement(conn.prepareStatement(parsedQuery.toString(),  type), sql, orderedParameters);
    }
