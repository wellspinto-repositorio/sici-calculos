...
public class ValorMasc implements KeyListener {
	...
	public void keyTyped(KeyEvent e) {   
     ...
     public void keyReleased(KeyEvent e) {
            ...
            if (textoAntes.isEmpty()) textoAntes = "000";
            if (Double.parseDouble(textoAntes.replace(".","").replace(",","")) <= 0) {
                textoAntes = "000";
            }
            if (textoAntes.replace(".","").replace(",","").length() == 2) {
                textoAntes = "00" + textoAntes;
            }
            if (textoAntes.replace(".","").replace(",","").length() == 1) {
                textoAntes = "000" + textoAntes;
            }
