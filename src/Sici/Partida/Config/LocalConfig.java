...
public class LocalConfig extends javax.swing.JInternalFrame {

    /**
     * Creates new form LocalConfig
     */
    public LocalConfig() {
        initComponents();
        pack();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle(".:: Configurações Locais");
        setMaximumSize(new java.awt.Dimension(789, 314));
        setMinimumSize(new java.awt.Dimension(789, 314));
        setNormalBounds(new java.awt.Rectangle(0, 0, 0, 0));
        setPreferredSize(new java.awt.Dimension(789, 314));
