...
public class jProprietarios_old extends javax.swing.JInternalFrame {
    Db conn = VariaveisGlobais.conexao;
    String sInativos = (!VariaveisGlobais.IProp ? "WHERE Lower(Trim(status)) = 'ativo'" : "WHERE Lower(Trim(status)) <> 'ativo'");
    ResultSet pResult = conn.OpenTable("SELECT * FROM proprietarios " + sInativos + "ORDER BY rgprp;", ResultSet.CONCUR_UPDATABLE, null);
    ...
    public jProprietarios_old() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(mNome, javax.swing.GroupLayout.PREFERRED_SIZE, 516, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(mTipoDoc, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                                ...
                                                .addGap(18, 18, 18)
                                                .addComponent(mCpf, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {mAgencia, mBairro, mBanco, mCCorrente, mCep, mCidade, mCnpj, mCodigo, mConjugue, mCpf, mCplto, mDtNasc, mDtNascConj, mDtNascRep, mEmail, mEndereco, mEstCivil, mFavorecido, mIdentidade, mNacionalidade, mNome, mNumero, mProfissao, mRepresentante, mTipoDoc});
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        if (n == JOptionPane.YES_OPTION) {
            ...
            try { LerDados(true); } catch (SQLException sqlEx) {}
        }
    ...
    private void GravarDados() throws SQLException { 
        ...
        if (bNew) {
            ...
            param = new Object[][] { 
                ...
                {"string", "tipoprop", mTipoDoc.getText().trim()},
                ...
                {"string", "cpfcnpj", mTipoDoc.getText().toUpperCase().contains("F") ? mCpf.getText().trim() : mCnpj.getText().trim()},
